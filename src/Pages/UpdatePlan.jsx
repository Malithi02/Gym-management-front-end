...
const planSchema = yup.object({
  ...
  workoutLogo: yup
    ...
    .required("Workout photo URL is required"),
...
const UpdatePlan = () => {
    const { id } = useParams();
    const { 
        _id, workoutName = "", trainerName = "", maxDuration = "", minDuration = "",
        durationType = "", difficultyLevel = "", postedDate = "", workoutLogo = "", 
        description = "", postedBy = "", equipments = [], workoutType = "", sessionType = ""
    } = useLoaderData() || {};
